...
ggsave(stratplot_legend,
  filename = paste0("data/Stacked_Barplots/", feature, "stackedbarplot_legend.svg"),
  width = 30, height = 7
)
# Save Barplot
stratplot_out <- stratplot + theme(legend.position = "none")
ggsave(stratplot_out,
  filename = paste0("data/Stacked_Barplots/", feature, "stackedbarplot.svg"),
  width = 12, height = 5
)
