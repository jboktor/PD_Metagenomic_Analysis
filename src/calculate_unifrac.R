...
mpa_infile <- "/Users/josephboktor/Documents/PD_Metagenomic_Analysis/files/RUSH_biobakery_output_slim/metaphlan/merged/metaphlan_taxonomic_profiles.tsv"
tree_file <- "/Users/josephboktor/Documents/PD_Metagenomic_Analysis/files/mpa_v30_CHOCOPhlAn_201901_species_tree.nwk"
outfile <- "Unifrac/RUSH_weighted_unifrac"
weighted <- T
normalize <- ""
