...
abun.pdpc.inpt <- abun.pdpc.filtered %>%
...
abun.pdhc.inpt <- abun.pdhc.filtered %>%
  column_to_rownames(var = "rowname") %>%
  t() %>%
  melt() %>%
...
ggsave(DAF_final,
  filename = paste0("figures/Figure_4/DAF_Figure_4.svg"),
  width = 14, height = 7.5
)

# Legends
ggsave(HL1.pc$Legends,
  filename = paste0("figures/Figure_4/DAF_Figure_4_PC.legend.svg"),
  width = 7, height = 7
)
ggsave(HL1.hc$Legends,
  filename = paste0("figures/Figure_4/DAF_Figure_4_HC.legend.svg"),
  width = 7, height = 7
)
