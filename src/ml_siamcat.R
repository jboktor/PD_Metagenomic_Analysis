...
siamcat.noShanghai <- siamcat(
  feat = abundances_noShanghai, meta = meta_noShanghai,
  label = "PD", case = "Yes"
)

siamcat.Shanghai <- siamcat(
  feat = abundances_Shanghai, meta = meta_Shanghai,
  label = "PD", case = "Yes"
)
