...
ggsave(Clostridia,
  filename = "data/Inflammation_Markers/Clostridia.png",
  height = 5, width = 2.5
)
...
ggsave(Bacteroidia,
  filename = "data/Inflammation_Markers/Bacteroidia.png",
  height = 5, width = 2.5
)
...
ggsave(Proteobacteria,
  filename = "data/Inflammation_Markers/Proteobacteria.png",
  height = 5, width = 2.5
)

Enterobacteriaceae <-
  plot.foi(dat.family, foi = "Enterobacteriaceae")
ggsave(Enterobacteriaceae,
  filename = "data/Inflammation_Markers/Enterobacteriaceae.png",
  height = 5, width = 2.5
)
...
FAvOA <- boxplot_all(
  df = ratio.plot, x = ratio.plot$group, y = (ratio.plot$ratio),
...
#        height = 4, width =4)
FAvOA_LR <- boxplot_all(
  df = ratio.plot, x = ratio.plot$group, y = log(ratio.plot$ratio),
  title = "Facultative / Obligate \nAnerobe Ratio",
  ylabel = "Natural Log-Ratio"
)
ggsave(FAvOA_LR,
  filename = "data/Inflammation_Markers/Facultative_vs_Obligate_Anaerobe_LogRatio.png",
  height = 3, width = 3
)
...
NuoABCDEFGHIJKLMN
# NADH dehydrogenase II (Ndh-2) :  EC 1.6.5.11
Ndh2 <- plot.foi(dat.ec.slim,
  foi = "1.6.5.11",
  title = "Ndh2 [1.6.5.11] \ndehydrogenase"
)
Ndh2
# Succinate dehydrogenase (SdhCDAB) : EC 1.3.5.1
SdhCDAB <- plot.foi(dat.ec.slim,
  foi = "1.3.5.1",
...
ggsave(CyoABCD,
  filename = "data/Inflammation_Markers/aerobic_respiration_Cytochrome_oxidase_CyoABCD.png",
  height = 5, width = 2.5
)
ggsave(CydAB,
  filename = "data/Inflammation_Markers/aerobic_respiration_Cytochrome_oxidase_CydAB.png",
  height = 5, width = 2.5
)
ggsave(NuoABCDEFGHIJKLMN,
  filename = "data/Inflammation_Markers/aerobic_respiration_NuoABCDEFGHIJKLMN.png",
  height = 5, width = 2.5
)
ggsave(Ndh2,
  filename = "data/Inflammation_Markers/aerobic_respiration_dehydrogenase_Ndh2.png",
  height = 5, width = 2.5
)
ggsave(SdhCDAB,
  filename = "data/Inflammation_Markers/aerobic_respiration_dehydrogenase_SdhCDAB.png",
  height = 5, width = 2.5
)
ggsave(ldh,
  filename = "data/Inflammation_Markers/aerobic_respiration_dehydrogenase_ldh.png",
  height = 5, width = 2.5
)
...
boxplot_all(
  df = ratio.plot, x = ratio.plot$group, y = (ratio.plot$value),
  title = "Aerobic Respiration Cytochrome Oxidases",
  ylabel = "Normalized Abundance Ratio"
)
boxplot_all(
  df = ratio.plot, x = ratio.plot$group, y = log(ratio.plot$value),
  title = "Aerobic Respiration Cytochrome Oxidases",
  ylabel = "Natural Log-Ratio"
)
...
ggsave(torR,
  filename = "data/Inflammation_Markers/anaerobic_respiration_N-oxide_reductases_torR.png",
  height = 5, width = 5
)
ggsave(torY,
  filename = "data/Inflammation_Markers/anaerobic_respiration_N-oxide_reductases_torY.png",
  height = 5, width = 5
)
ggsave(yedY,
  filename = "data/Inflammation_Markers/anaerobic_respiration_N-oxide_reductases_yedY.png",
  height = 5, width = 5
)
...
K03386
ggsave(K03386,
  filename = "data/Inflammation_Markers/K03386.png",
  height = 5, width = 5
)
...
K02007
ggsave(K02007,
  filename = "data/Inflammation_Markers/K02007.png",
  height = 5, width = 5
)

cytochrome_c_peroxidase <- plot.foi(dat.ec.slim,
  foi = "1.11.1.5",
  title = "1.11.1.5"
)
cytochrome_c_peroxidase
ggsave(cytochrome_c_peroxidase,
  filename = "data/Inflammation_Markers/cytochrome_c_peroxidase.png",
  height = 5, width = 2.5
)

cytochrome_c_catalase <- plot.foi(dat.ec.slim,
  foi = "1.11.1.6",
  title = "EC: 1.11.1.6\n catalase-peroxidase"
)
cytochrome_c_catalase
ggsave(cytochrome_c_catalase,
  filename = "data/Inflammation_Markers/cytochrome_c_catalase_merged.png",
  height = 5, width = 2.5
)
