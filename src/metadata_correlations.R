...
# Scatter plots
top_n_scatterplots(
  dat = phyloseq_objs[["Species"]], obj.name = "Species",
...
# Scatter plots
top_n_scatterplots(
  dat = phyloseq_objs[["Pathways.slim"]], obj.name = "Pathways.slim",
...
ggsave(h3,
  filename = "data/Correlations/Pathways.slim/Clinical/Heatmap_Pathways.slim_clinical.svg",
  height = 10, width = 13
)
ggsave(h4,
  filename = "data/Correlations/Pathways.slim/Diet/Heatmap_Pathways.slim_diet.svg",
  height = 9, width = 11
)
...
# Scatter plots
top_n_scatterplots(
  dat = phyloseq_objs[["KOs.slim"]], obj.name = "KOs.slim",
...
ggsave(h5,
  filename = "data/Correlations/KOs.slim//Clinical/Heatmap_KOs.slim_clinical.svg",
  height = 10, width = 12
)
ggsave(h6,
  filename = "data/Correlations/KOs.slim/Diet/Heatmap_KOs.slim_diet.svg",
  height = 10, width = 13
)
...
# Scatter plots
top_n_scatterplots(
  dat = phyloseq_objs[["GOs.slim"]], obj.name = "GOs.slim",
...
ggsave(h7,
  filename = "data/Correlations/GOs.slim/Clinical/Heatmap_GOs.slim_clinical.svg",
  height = 10, width = 13
)
ggsave(h8,
  filename = "data/Correlations/GOs.slim/Diet/Heatmap_GOs.slim_diet.svg",
  height = 10, width = 13
)
...
# Scatter plots
top_n_scatterplots(
  dat = phyloseq_objs[["Pfams.slim"]], obj.name = "PFAMs.slim",
...
ggsave(h9,
  filename = "data/Correlations/PFAMs.slim/Clinical/Heatmap_PFAMs.slim_clinical.svg",
  height = 10, width = 12
)
ggsave(h10,
  filename = "data/Correlations/PFAMs.slim/Diet/Heatmap_PFAMs.slim_diet.svg",
  height = 10, width = 13
)
...
clinical_corrs <-
  list(
    Species = corrs.clinical.species,
